...
public class CallsEndpoint {
    ...
    public CallsEndpoint(RestApiClient client) {
        this.client = client;
    }
     ...
     */
    public Page<Call> findCalls(FindCallsRequest request) throws CallfireApiException, CallfireClientException {
     ...
     * @throws CallfireClientException in case error has occurred in client
     */
    public Call getCall(Long id) throws CallfireApiException, CallfireClientException {
     ...
     * @throws CallfireClientException in case error has occurred in client
     */
    public Call getCall(Long id, String fields) throws CallfireApiException, CallfireClientException {
