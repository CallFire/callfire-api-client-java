...
public class SubscriptionsApiTest extends AbstractApiTest {
    ...
    public void testCreate() throws Exception {
        String responseJson = getJsonPayload("/webhooks/subscriptionsApi/response/createSubscription.json");
        String requestJson = getJsonPayload("/webhooks/subscriptionsApi/request/createSubscription.json");
    ...
    public void testFind() throws Exception {
        String expectedJson = getJsonPayload("/webhooks/subscriptionsApi/response/findSubscriptions.json");
    ...
    public void testGet() throws Exception {
        String expectedJson = getJsonPayload("/webhooks/subscriptionsApi/response/getSubscription.json");
        ArgumentCaptor<HttpUriRequest> captor = mockHttpResponse(expectedJson);
    ...
    public void testUpdate() throws Exception {
        String expectedJson = getJsonPayload("/webhooks/subscriptionsApi/request/updateSubscription.json");
