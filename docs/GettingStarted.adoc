...
dependencies {
    compile 'com.callfire:callfire-api-client:1.5.0'
}
...
[source]
    callfire-api-client-1.5.0.jar
    callfire-api-client-1.5.0-all.jar - client jar with all dependencies inside
    callfire-api-client-1.5.0-javadoc.jar
    callfire-api-client-1.5.0-sources.jar
