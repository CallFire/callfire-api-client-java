...
Use this method to add recipients to an already created voice broadcast. Post a list of Recipient objects for
 them to be immediately added to the voice broadcast campaign. These contacts do not go through validation process,
